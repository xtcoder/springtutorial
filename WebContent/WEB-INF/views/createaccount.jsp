		...
		<fieldset>
			...
			<div class="form-group">
				<label class="col-md-4 control-label" for="username">User
					Name:</label>
				<div class="col-md-4">
					<sf:input id="username" name="username" path="username"
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<sf:input id="email" name="email" path="email" placeholder=""
			...
			<div class="form-group">
				<label class="col-md-4 control-label" for="confirmpassword">Confirm
					Password:</label>
				<div class="col-md-4">
					<input id="confirmpassword" name="confirmpassword" placeholder=""
